...
public class ExempleDistributeurContratCadreVendeurAcheteur extends ExempleTransformateurContratCadreVendeur implements IAcheteurContratCadre, IFabricantChocolatDeMarque{
	protected List<ExemplaireContratCadre> mesContratEnTantQuAcheteur;

	public ExempleDistributeurContratCadreVendeurAcheteur(Object produit) {
		super(produit);
