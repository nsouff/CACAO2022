...
public class Producteur2Acteur extends Producteur2Stockage2 implements IActeur,IVendeurBourse {
	...
	public void next() {
		...
		//journal, Jules DORE
		journal.ajouter("Stock Feve Moyenne : "+this.getStock(Feve.FEVE_MOYENNE)+", Production Feve Moyenne : "+this.production(Feve.FEVE_MOYENNE)+", Nombre d'arbre Moyenne : "+this.getNbArbre(Feve.FEVE_MOYENNE)+""+"Rendement : "+this.getRendement(Feve.FEVE_MOYENNE));
