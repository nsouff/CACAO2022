...
public class Producteur2VendeurContratCadre extends Producteur2Acteur implements IVendeurContratCadre{
	...
	public void next() {
		...
		this.journalCC.ajouter("Quantité par step de Feve HAUTE BIO EQUITABLE : "+this.qtiteTotaleContratEnCours(Feve.FEVE_HAUTE_BIO_EQUITABLE )+" Vente sur les 50 dernier next "+this.ventePourcent(Feve.FEVE_HAUTE_BIO_EQUITABLE));
		this.journalCC.ajouter("Quantité par step de Feve MOYENNE BIO EQUITABLE : "+this.qtiteTotaleContratEnCours(Feve.FEVE_MOYENNE_BIO_EQUITABLE)+" Vente sur les 50 dernier next "+this.ventePourcent(Feve.FEVE_MOYENNE_BIO_EQUITABLE));
...
//	@Override
	...
	public void notificationNouveauContratCadre(ExemplaireContratCadre contrat) {
		if((contrat.getProduit()==Feve.FEVE_HAUTE_BIO_EQUITABLE)||(contrat.getProduit()==Feve.FEVE_MOYENNE_BIO_EQUITABLE)) {
			...
			this.journalCC.ajouter("Contrat Cadre Non Bio : " + Journal.texteColore(contrat.getAcheteur(), contrat.getAcheteur().getNom())+" Acheteur " + contrat.getAcheteur()+ " Produit : " + contrat.getProduit() + " Quantité : "+contrat.getQuantiteTotale()+" Prix : " + contrat.getPrix() );
		}
	}
