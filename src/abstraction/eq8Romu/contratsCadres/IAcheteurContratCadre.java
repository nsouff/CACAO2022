...
public interface IAcheteurContratCadre extends IActeur {
	 ...
	 * l'acheteur de la livraison de quantite kg de produit (dans le cadre du
	 * contrat contrat). Il se peut que la quantitee livre soit inferieure a la
	 * quantite prevue par le contrat si le vendeur est dans l'incapacite de la
	 * fournir. Dans ce cas, le vendeur aura une penalite (un pourcentage de produit
	 * a livrer en plus). L'acheteur doit a minima mettre ce produit dans son stock.
	 * 
	 * @param produit
	 * @param quantite
	 * @param contrat
