...
public class SuperviseurVentesContratCadre implements IActeur, IAssermente {
	 ...
	 */
	public ExemplaireContratCadre demandeAcheteur(IAcheteurContratCadre acheteur, IVendeurContratCadre vendeur, Object produit, Echeancier echeancier, int cryptogramme, boolean tg) {
		if (acheteur==null) {
	 ...
	 * @return L'exemplaire de contrat cadre conclu en cas d'accord (null si un accord n'a pas pu etre trouve)
	 */
	public ExemplaireContratCadre demandeVendeur(IAcheteurContratCadre acheteur, IVendeurContratCadre vendeur, Object produit, Echeancier echeancier, int cryptogramme, boolean tg) {
		if (acheteur==null) {
		...
		journal.ajouter(Journal.texteColore(vendeur, vendeur.getNom())+" lance le contrat #"+contrat.getNumero()+" de "+contrat.getQuantiteTotale()+" kg de "+contrat.getProduit()+" a "+Journal.texteColore(acheteur, acheteur.getNom()));
