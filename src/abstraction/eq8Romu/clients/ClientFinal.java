...
public class ClientFinal implements IActeur, IAssermente {
	...
	public void next() {
		...
		for (IDistributeurChocolatDeMarque distri : Filiere.LA_FILIERE.getDistributeurs()) {
			...
			if (quantiteTG>(quantiteTotale*POURCENTAGE_MAX_EN_TG)) {
				...
				this.JournalDistribution.ajouter("---"+Journal.texteColore(distri, distri.getNom())+" met en TG "+Journal.doubleSur(quantiteTG, 2)+" Kg / "+Journal.doubleSur(quantiteTotale, 2)+" Kg au prix de "+pri);
			}
		}
